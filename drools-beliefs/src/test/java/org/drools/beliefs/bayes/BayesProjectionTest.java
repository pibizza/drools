...
public class BayesProjectionTest {
    ...
    public void testProjection2() {
        ...
        BayesVariable a = new BayesVariable<>("A", 0, new String[] {"A1", "A2"},  new double[][] {{0.1, 0.2}});
        BayesVariable b = new BayesVariable<>("B", 1, new String[] {"B1", "B2"},  new double[][] {{0.1, 0.2}});
        BayesVariable c = new BayesVariable<>("C", 2, new String[] {"C1", "C2"},  new double[][] {{0.1, 0.2}});
