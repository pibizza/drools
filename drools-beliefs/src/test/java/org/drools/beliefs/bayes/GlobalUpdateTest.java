...
public class GlobalUpdateTest {
    ...
    @Before
    public void startUp() {
        List<JunctionTreeSeparator> list = new ArrayList<>();
...
//        assertThat(globalUpdateResults).containsExactly("0", "1", "2", "3", "4", "5", "6", "7", "8");
        assertThat(globalUpdateResults).containsExactly("0");
    }

    private void connectChildren(Graph<BayesVariable> graph, JunctionTreeClique parent, List list, JunctionTreeClique... children) {
