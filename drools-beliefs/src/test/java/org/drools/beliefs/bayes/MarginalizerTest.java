...
public class MarginalizerTest {
    ...
    @Test
    public void test1() {
        BayesVariable a = new BayesVariable<>("A", 0, new String[] {"A1", "A2", "A3"}, null);
        BayesVariable b = new BayesVariable<>("B", 1, new String[] {"B1", "B2", "B3"}, null);
        BayesVariable c = new BayesVariable<>("C", 2, new String[] {"C1", "C2", "C3"}, null);
