...
public class PatternBuilder
    ...
    protected List<Constraint> build(RuleBuildContext context,
        ...
        for (BaseDescr d : initialDescrs) {
            ...
            Constraint constraint = isXPath ? buildXPathDescr(context, patternDescr, pattern, (ExpressionDescr) d, mvelCtx) : buildCcdDescr(context, patternDescr, pattern, d, descr, mvelCtx);
            if (constraint != null) {
